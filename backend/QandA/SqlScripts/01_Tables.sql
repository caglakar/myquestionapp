...
VALUES(1, 1, 'To catch problems earlier speeding up your developments', '2', 'cagla.test@test.com', '2021-01-18 14:40')

INSERT INTO dbo.Answer(AnswerId, QuestionId, Content, UserId, UserName, Created)
VALUES(2, 1, 'So, that you can use the JavaScript features of tomorrow, today', '3', 'abc.test@test.com', '2021-01-18 16:18')
GO
